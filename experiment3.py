"""
experiment 3
DDPG with policy return method.
"""
...
class Actor(object):
    ...
    def soft_go_back(self):
        ...
        self.sess.run(e_ini)
        self.sess.run(t_ini)
        self.sess.run([[tf.assign(t, tt*TAU+t*(1-TAU)) ,tf.assign(e, te*TAU+e*(1-TAU))]for tt,te, t, e in zip(self.t_t_params, self.t_e_params,self.t_params, self.e_params)])
